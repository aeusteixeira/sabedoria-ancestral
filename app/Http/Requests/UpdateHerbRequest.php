...
class UpdateHerbRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique('herbs', 'name')->ignore($this->id),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'name.unique' => 'Já existe outra erva com este nome.',
            ...
            'temperature_regent_id.required' => 'A temperatura da erva é obrigatória.',
            'temperature_regent_id.exists' => 'A temperatura selecionada não é válida.',
